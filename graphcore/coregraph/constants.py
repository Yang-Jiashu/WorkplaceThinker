"""
Centralized configuration constants for GraphCore.

This module defines default values for configuration constants used across
different parts of the GraphCore system. Centralizing these values ensures
...
DEFAULT_MAX_ENTITY_TOKENS = 15000
DEFAULT_MAX_RELATION_TOKENS = 15000
...
DEFAULT_LOG_FILENAME = "graphcore.coregraph.log"  # Default log filename

# Ollama server configuration defaults
DEFAULT_OLLAMA_MODEL_NAME = "graphcore.coregraph"
DEFAULT_OLLAMA_MODEL_TAG = "latest"
DEFAULT_OLLAMA_MODEL_SIZE = 7365960935
DEFAULT_OLLAMA_CREATED_AT = "2024-01-15T00:00:00Z"
DEFAULT_OLLAMA_DIGEST = "sha256:graphcore.coregraph"

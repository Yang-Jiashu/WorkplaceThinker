...
def read_long_description():
    try:
        ...
        return "WorkplaceThinker - workplace relationship intelligence"
...
setuptools.setup(
    name="workplace-thinker",
    url=metadata["__url__"],
    version=metadata["__version__"],
    author=metadata["__author__"],
    description="WorkplaceThinker: workplace relationship graph and hidden-risk intelligence",
